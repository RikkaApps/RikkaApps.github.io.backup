...
2. 下载 [Riru - Storage Redirect v19.3](https://github.com/RikkaApps/StorageRedirect-assets/releases/download/assets/magisk-riru-storage-redirect-v19.3.zip)（如果要使用 v19.3 及以上版本，Core 必须升级到 v18 及以上，否则无法开机）
3. 在 Magisk 中安装这两个模块
