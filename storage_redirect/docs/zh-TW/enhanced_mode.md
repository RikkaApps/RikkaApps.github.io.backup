...
2. 下載 [Riru - Storage Redirect v19](https://github.com/RikkaApps/StorageRedirect-assets/releases/download/assets/magisk-riru-storage-redirect-v19.zip)（如果要使用 v18 及以上版本，Core 必須升級到 v16，否則無法開機）
3. 在 Magisk 中安裝這兩個模組
